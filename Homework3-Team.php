...
$teamName = "Group 4 (D)";
$groupMember = array("21910190" => "Amir Alatrash", "21910124" => "Ameer Rishmawi", "21910289" => "Renad Zboon", "21920004" => "Dana Nofal");
...
for ($row = 1; $row <= 10; $row++)   // First Loop 
{
    ...
    if ($row == 1) {                // Please Print X on the top corner
        echo "<td >X</td>";
    }
    ...
    for ($col = 1; $col <= 9; $col++) {     // Second Loop
